...
if __name__ == "__main__":
    ...
    confusion_matrix_img = "results/confusion_matrix.png"
    
    if os.path.exists(training_log_path):
        epochs, losses, accuracies = read_training_log(training_log_path)
        plot_and_save_training_curve(epochs, losses, accuracies, output_file="training_curve.png")
    else:
    ...
    if os.path.exists(final_metrics_path):
        ...
        plot_and_save_final_metrics(metrics_dict, output_file="final_metrics.png")
    else:
